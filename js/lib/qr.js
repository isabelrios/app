define(["exports"], function (exports) {
  ...
  var FINGERPRINT_PART = 1;

  var Qr = (function () {
    var Qr = function Qr() {
      if (cordova && cordova.plugins && cordova.plugins.barcodeScanner && cordovaHTTP && cordovaHTTP.acceptHss) {
        this.supported = true;
      } else {
    ...
    Qr.prototype.connectTo = function (url, cb) {
      if (!this.supported) {
    ...
    Qr.prototype.scanQR = function (cb) {
      if (!cb) {
        cb = function (result) {
          console.log(result);
        };
